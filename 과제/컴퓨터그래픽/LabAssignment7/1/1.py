...
lightColorArr=(1,1,1,1)
objectColorArr=(1,0,0,1)
def render():
    global gCamAng, gCamHeight,lightColorArr,objectColorArr
...
def key_callback(window, key, scancode, action, mods):
    ...
    if action==glfw.PRESS or action==glfw.REPEAT:
        if key==glfw.KEY_1:
            ...
            lightColorArr=[1,0,0,1]
        elif key==glfw.KEY_S:
            lightColorArr=[0,1,0,1]
        elif key==glfw.KEY_D:
            lightColorArr=[0,0,1,1]
        elif key==glfw.KEY_F:
            lightColorArr=[1,1,1,1]
        elif key==glfw.KEY_Z:
            objectColorArr=[1,0,0,1]
        elif key==glfw.KEY_X:
            objectColorArr=[0,1,0,1]
        elif key==glfw.KEY_C:
            objectColorArr=[0,0,1,1]
        elif key==glfw.KEY_V:
            objectColorArr=[1,1,1,1]
